...
function buildSystemPrompt(style: WritingStyle): string {
  return compactJoin([
    ...
    "When writing a cover letter: keep it to ONE page (3-4 short paragraphs, ~250-300 words total).",
    "Cover letter structure: (1) Hook opening — name the role + one specific reason you want THIS company; (2) Value paragraph — 2-3 quantified achievements directly matching JD requirements; (3) Fit paragraph — how your background solves their stated challenge; (4) Call to action — one sentence expressing eagerness to discuss.",
    "Cover letter rules: no clichés ('I am writing to apply'), no hollow adjectives ('passionate', 'dynamic'), no repetition of the resume. Every sentence must add new information. Use active voice and specific numbers.",
